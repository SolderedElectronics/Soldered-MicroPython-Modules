# FILE: SimpleFireSensor.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: MicroPython library for Soldered Simple Fire Sensor
...
class SimpleFireSensor(SimpleSensor):
    """
    MicroPython class for Soldered Simple Fire/Flame Sensor.
    Detects infrared radiation from flames using a photodiode.
    ...
    def isFireDetected(self) -> bool:
        """
        Check if fire or flame is detected above threshold.
        ...
        :returns: bool, True if fire detected
        """
