# FILE: SimpleLightSensor.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: MicroPython library for Soldered Simple Light Sensor
...
class SimpleLightSensor(SimpleSensor):
    """
    MicroPython class for Soldered Simple Light Sensor.
    Detects ambient light level using a photoresistor (LDR).
    ...
    def isLightDetected(self) -> bool:
        """
        Check if light is detected above threshold.
        ...
        :returns: bool, True if light detected
        """
