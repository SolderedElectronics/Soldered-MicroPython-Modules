# FILE: SimpleRainSensor.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: MicroPython library for Soldered Simple Rain Sensor
...
class SimpleRainSensor(SimpleSensor):
    """
    MicroPython class for Soldered Simple Rain Sensor.
    Detects rain and moisture using resistive sensing.
