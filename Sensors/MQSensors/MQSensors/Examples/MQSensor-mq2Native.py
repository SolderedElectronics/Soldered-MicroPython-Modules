# FILE: MQSensor-mq2Native.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read LPG concentration from the MQ-2 sensor (native)
# WORKS WITH: MQ-2 gas sensor breakout: www.solde.red/333196
# LAST UPDATED: 2026-04-30

from MQSensor import MQ2  # Import the MQ2 class
...
# Create an instance of the MQ2 sensor object (native mode)
sensor = MQ2(analog_pin=ANALOG_PIN)
