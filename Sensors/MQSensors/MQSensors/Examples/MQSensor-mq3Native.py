# FILE: MQSensor-mq3Native.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read alcohol concentration from the MQ-3 sensor (native)
# WORKS WITH: MQ-3 gas sensor breakout: www.solde.red/333197
...
# Create an instance of the MQ3 sensor object (native mode)
sensor = MQ3(analog_pin=ANALOG_PIN)
