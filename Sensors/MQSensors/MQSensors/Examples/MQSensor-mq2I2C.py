# FILE: MQSensor-mq2I2C.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read LPG concentration from the MQ-2 sensor (Qwiic)
# WORKS WITH: MQ-2 gas sensor with Qwiic: www.solde.red/333196
...
# Create an instance of the MQ2 sensor object (Qwiic mode)
sensor = MQ2()

# You can also define a custom I2C communication and address if needed:
# i2c = I2C(0, scl=Pin(22), sda=Pin(21))
# sensor = MQ2(i2c=i2c, address=0x30)
