# FILE: MQSensor-mq131I2C.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read O3 concentration from the MQ-131 sensor (Qwiic)
# WORKS WITH: MQ-131 gas sensor with Qwiic: www.solde.red/333205
...
# Create an instance of the MQ131 sensor object (Qwiic mode)
sensor = MQ131()

# You can also define a custom I2C communication and address if needed:
# i2c = I2C(0, scl=Pin(22), sda=Pin(21))
# sensor = MQ131(i2c=i2c, address=0x30)
