# FILE: MQSensor-mq6Native.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read LPG concentration from the MQ-6 sensor (native)
# WORKS WITH: MQ-6 gas sensor breakout: www.solde.red/333200
...
# Create an instance of the MQ6 sensor object (native mode)
sensor = MQ6(analog_pin=ANALOG_PIN)
