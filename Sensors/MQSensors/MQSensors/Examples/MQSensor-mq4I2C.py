# FILE: MQSensor-mq4I2C.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read CH4 concentration from the MQ-4 sensor (Qwiic)
# WORKS WITH: MQ-4 gas sensor with Qwiic: www.solde.red/333198
...
# Create an instance of the MQ4 sensor object (Qwiic mode)
sensor = MQ4()

# You can also define a custom I2C communication and address if needed:
# i2c = I2C(0, scl=Pin(22), sda=Pin(21))
# sensor = MQ4(i2c=i2c, address=0x30)
