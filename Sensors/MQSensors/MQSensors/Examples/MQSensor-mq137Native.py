# FILE: MQSensor-mq137Native.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read NH3 concentration from the MQ-137 sensor (native)
# WORKS WITH: MQ-137 gas sensor breakout: www.solde.red/333206
# LAST UPDATED: 2026-04-30

from MQSensor import MQ137  # Import the MQ137 class
...
# Create an instance of the MQ137 sensor object (native mode)
sensor = MQ137(analog_pin=ANALOG_PIN)
