# FILE: MQSensor-mq8Native.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read H2 concentration from the MQ-8 sensor (native)
# WORKS WITH: MQ-8 gas sensor breakout: www.solde.red/333202
...
# Create an instance of the MQ8 sensor object (native mode)
sensor = MQ8(analog_pin=ANALOG_PIN)
