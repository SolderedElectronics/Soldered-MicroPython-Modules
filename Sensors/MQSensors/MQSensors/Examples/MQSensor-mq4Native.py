# FILE: MQSensor-mq4Native.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read CH4 concentration from the MQ-4 sensor (native)
# WORKS WITH: MQ-4 gas sensor breakout: www.solde.red/333198
# LAST UPDATED: 2026-04-30

from MQSensor import MQ4  # Import the MQ4 class
...
# Create an instance of the MQ4 sensor object (native mode)
sensor = MQ4(analog_pin=ANALOG_PIN)
