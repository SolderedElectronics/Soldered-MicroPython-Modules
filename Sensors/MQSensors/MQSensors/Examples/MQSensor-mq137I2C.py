# FILE: MQSensor-mq137I2C.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read NH3 concentration from the MQ-137 sensor (Qwiic)
# WORKS WITH: MQ-137 gas sensor with Qwiic: www.solde.red/333206
...
# Create an instance of the MQ137 sensor object (Qwiic mode)
sensor = MQ137()

# You can also define a custom I2C communication and address if needed:
# i2c = I2C(0, scl=Pin(22), sda=Pin(21))
# sensor = MQ137(i2c=i2c, address=0x30)
