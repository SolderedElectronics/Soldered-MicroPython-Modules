# FILE: MQSensor-mq5I2C.py
# AUTHOR: Fran Fodor @ Soldered
# BRIEF: An example showing how to read LPG concentration from the MQ-5 sensor (Qwiic)
# WORKS WITH: MQ-5 gas sensor with Qwiic: www.solde.red/333199
...
# Create an instance of the MQ5 sensor object (Qwiic mode)
sensor = MQ5()

# You can also define a custom I2C communication and address if needed:
# i2c = I2C(0, scl=Pin(22), sda=Pin(21))
# sensor = MQ5(i2c=i2c, address=0x30)
