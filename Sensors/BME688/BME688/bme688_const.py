...
# Error Messages
BME_688_CHECK_CONN_ERR = "BME688 is disconnected. Check connections or make sure it is working."
...
BME_688_TEMP_EXCEED_MAX_LIMIT = "Exception: Operation blocked. The temperature value exceeds maximum limit."
BME_688_PROFILE_OUT_OF_RANGE = "Exception: Operation blocked. Profile value should be between 0 and 9."
