...
# Using HSPI 
spi = machine.SPI(1, baudrate=1000000, polarity=1, phase=1, sck=machine.Pin(18), mosi=machine.Pin(23), miso=machine.Pin(19))
...
def print_time():
    ...
    if PRINT_USA_DATE:
        print(str(rtc.month()) + "/" + str(rtc.date()) + "/", end="")  # Print month/date
    else:
        print(str(rtc.date()) + "/" + str(rtc.month()) + "/", end="")  # Print date/month
