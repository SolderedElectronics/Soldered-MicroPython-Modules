...
class RFID:
    ...
    def __init__(self, i2c=None, i2c_address=0x30, rx_pin=None, tx_pin=None, baud_rate=9600):
        """
        ...
        if i2c is not None:
            ...
            # UART mode
            self.native = True
            self.rfid_serial = UART(1, baudrate=baud_rate, rx=Pin(rx_pin), tx=Pin(tx_pin))
            self.rx_pin = rx_pin
            self.tx_pin = tx_pin
